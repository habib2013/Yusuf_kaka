...
<head>
  ...
  <body>
    ...
    <div
      class="bg-shape"
      style=" background:linear-gradient(180deg, rgba(30, 24, 53, 0.4) 0%, rgba(30, 24, 53, 0.4) 90.16%), url(../myassets/images/post-hero-img.jpg); background-size: cover; background-repeat: no-repeat;height:65vh;
        ...
        <div class="row">
          ...
          >
            ...
            <h3 class="mb-3">{{$blog->title}}</h3>
              ...
              <img
                src="../myassets/images/{{$blog->blog_image}}"
                alt=""
