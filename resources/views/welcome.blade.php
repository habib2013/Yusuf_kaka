      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-lg-6 col-md-12">
            <div class="text-white pr-10 mb-8 mb-lg-0">
            ...
            <div class="img-overlay">
              <a href="#">
                <img
                  ...
                  src="myassets/images/course-img-1.png"
                  alt=""
                />
              </a>
              <div class="caption">
          ...
          <div class="col-lg-6 col-md-6 mb-5">
            <div class="img-overlay">
              <a href="#">
                <img
                  class="rounded img-fluid"
                  src="myassets/images/course-img-2.png"
                  alt=""
                />
              </a>
              <div class="caption">
        ...
        <div class="row">
          <div class="offset-xl-3 col-xl-6 col-md-12">
            <div class="text-center mb-8">
              <h2 class="mb-3">Master Every Area of Your Life</h2>
              <p class="lead">
          ...
          <div class="row">
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-airbnb.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-digitalocean.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-facebook.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-discord.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-intercom.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-twitch.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-paypal.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-netflix.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-xboxone.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-instagram.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-pinterest.svg" alt="" />
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-6">
              <div class="mb-4 text-center">
                <img src="myassets/images/logo-stripe.svg" alt="" />
              </div>
            </div>
          </div>
        </div>
