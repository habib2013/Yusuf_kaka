...
<div id="cmsmasters_row_xqif9uu3x" class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_boxed">
	...
	<div class="cmsmasters_posts_slider cmsmasters_posts_slider_type_post cmsmasters_border" >
		...
		<div class="cmsmasters_slider_post_date_img_wrap"><figure class="cmsmasters_img_rollover_wrap preloader">
            <img width="580" height="360" src="images/{{$home_blog->blog_image}}" class="full-width wp-post-image" alt="Chemistry for Children and Teenagers" title="{{$home_blog->title}}" srcset="images/{{$home_blog->blog_image}}, images/{{$home_blog->blog_image}} 860w,images/{{$home_blog->blog_image}} 1160w" sizes="(max-width: 580px) 100vw, 580px" />
            <div class="cmsmasters_img_rollover"><a href="https://ecole.cmsmasters.net/2018/12/10/chemistry-for-children-and-teenagers/" title="Chemistry for Children and Teenagers" class="cmsmasters_open_link"></a></div></figure></div><div class="data_cat">
            <span class="cmsmasters_slider_post_date"><abbr class="published" title="December 10, 2018"></abbr><abbr class="dn date updated" title="July 30, 2019">July 30, 2019</abbr></span></div><div class="cmsmasters_slider_post_inner"><header class="cmsmasters_slider_post_header entry-header"><h4 class="cmsmasters_slider_post_title entry-title"><a href="https://ecole.cmsmasters.net/2018/12/10/chemistry-for-children-and-teenagers/">{{$home_blog->title}}</a></h4></header><div class="cmsmasters_slider_post_content entry-content">
	<p>{{ substr(strip_tags($home_blog->body), 0, 120) }}  {{ strlen(strip_tags($home_blog->body)) > 50 ? "..." : "" }}.” </p>
	</div>
	</div>	</div>
    </article>
    @endforeach
