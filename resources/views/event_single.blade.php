...
<!-- Mirrored from easetemplate.com/html/coach/pages/event-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 May 2020 13:40:56 GMT -->
<head>
    <title>Coach - Event Single Page</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    <!-- hero section -->
    <div
      style=" background:linear-gradient(180deg, rgba(30, 24, 53, 0.4) 0%, rgba(30, 24, 53, 0.4) 90.16%), url(myassets/images/event-single-hero-img.jpg); background-size: cover; background-repeat: no-repeat;
     "
    >
      <div class="container">
        <div class="py-lg-15 py-12 text-center ">
          <div class="row">
            <div class="offset-lg-1 col-lg-10 col-md-12 col-12 mb-3 mb-lg-0">
              <h1 class="font-weight-bold text-white mb-lg-3 mb-2 display-4">
                How To Be A Great Manager
              </h1>
              <p class="text-light mb-5 lead">Tuesday, February 25, 2020</p>
          ...
          <div class="col-lg-8 col-md-8 col-12">
            <div class="mb-8">
              ...
              <p class="lead text-dark">
                In sed lectus turpis. Nunc maximus lectus quis leo efficitur, eu
                posuere nisi euismod. Pellentesque non sagittis justo. Vivamus
                tellus libero, venenatis at erat in, commodo maximus odio.
              </p>
              <p>
                Nulla imperdiet ornare mauris vel varius. Morbi tincidunt ornare
                efficitur. Praesent dapibus eros et felis blandit molestie.
                Aliquam at fringilla nisi, eget scelerisque magna. Suspendisse
                tempus ipsum dui.
              </p>
            ...
            <div class="mb-8">
              ...
              <div
                class=" text-center pt-13 pb-13 pb-5 rounded-lg"
                style="background: url(myassets/images/video-img-second.jpg);
