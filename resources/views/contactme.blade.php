...
<head>
  ...
  <body>
    ...
    <div
      class="bg-shape"
      style=" background:linear-gradient(180deg, rgba(30, 24, 53, 0.4) 0%, rgba(30, 24, 53, 0.4) 90.16%), url(myassets/images/contact-hero-img.jpg); background-size: cover; background-repeat: no-repeat;
